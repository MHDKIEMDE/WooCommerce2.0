@extends('layouts.app')
@section('Agribusiness Shop', 'Details du produit')
@section('content')
        ...
        <div class="container py-5">
            <div class="row g-4 mb-5">
                <div class="col-lg-8 col-xl-9">
                    @if ($productsWithCategories->count() === 0)
                        <div class="col">Aucune catégorie disponible pour ce produit.</div>
                    @else
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    @if ($product->categories)
                                        <p class="mb-3">Catégorie: {{ $product->categories->name }}</p>
                                    @else
                                        Aucune catégorie définie
                                    @endif

                                    <h5 class="fw-bold mb-3">f{{ $product->price }} </h5>
                                    ...
                                    <p class="mb-4">description long</p>
